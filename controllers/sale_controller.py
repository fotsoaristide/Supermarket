class SaleController:
    ...
    def start_sale(self):
        ...
        self.sale_view.show_message(f"Nouvelle vente démarrée (ID: {sale_id})")
        return sale_id
    ...
    def add_product(self):
        ...
        try:
            ...
            self.sale_view.show_message("Produit ajouté avec succès.")
    ...
    def show_current_sale(self):
        ...
        if not sale_data:
            self.sale_view.show_message("Aucune vente en cours.")
            return
    ...
    def end_sale(self):
        ...
        self.sale_view.show_message(f"Vente terminée. TOTAL = {total} FCFA")
